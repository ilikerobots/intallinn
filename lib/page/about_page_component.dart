...
class AboutComponent implements OnInit, AfterViewInit {

  final ContentService _contentService;
  final LoggerService _logService;
  final DomSanitizationService _trustService;

  static final String pageId = "about";
  SafeHtml contents;

  AboutComponent(this._contentService, this._logService, this._trustService);
