...
class ClientPhotoService implements PhotoService {
  ...
  ClientPhotoService(this._http, this._config, this._logger);

  String _getPhotoUrl(PhotoCategory type, String id) =>
      "${_config.photoUrlPrefix}images/${_categoryToPath(type)}/$id.jpg";
  ...
  Future<Attribution> _getPhotoAttribution(PhotoCategory type,
    ...
    final String url = "${_config.photoUrlPrefix}images/${_categoryToPath(
        type)}/$id.jpg.license";
    try {
